...
def getContent(word, head, proxy,page,content):
    ...
    url = "https://www.jianshu.com/search/do?q={}&type=note&page={}&order_by=default".format(
        word,page)
    req = requests.post(url=url, headers=head, timeout=30, proxies=proxy)
